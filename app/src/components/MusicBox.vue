...
<template>
  <div class="music-player" @click="close('bottom');$store.commit('playBox',true)">
    ...
    <div style="float:left;line-height:20px;font-size:12px;padding-left:10px" >
      <div style="height:25px;font-size:14px;padding-top:5px;max-width:calc(100vw - 215px)" class="ellipsis">
        {{musicData.name}}
      </div>
    ...
    <div style="float:right;font-size:25px">
      ...
      <svg @click.stop="$store.commit('nextSong')" t="1494522150855" class="icon" style="font-size:18px;width: 2em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;"
    ...
    <mu-content-block style="height:300px;overflow-y:auto">
      <mu-list v-if="songlist.length>0" style="font-size:14px">
            ...
            <svg v-if="item.like"  t="1494777919068" class="icon" style="color:red;padding-bottom:3px;font-size:18px;width: 2em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;"
  				...
  				<div @click.stop="$store.commit('deleteSonglist',index)" slot="right">
  					...
  					<svg t="1494945300021" class="icon" style="padding-bottom:3px;font-size:12px;width: 1em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2995"><path d="M572.462111 512.016l438.898284-438.898284c16.767476-16.703478 16.767476-43.83863 0-60.47811-16.703478-16.767476-43.83863-16.767476-60.47811 0L511.984 451.537889 73.085716 12.575607c-16.703478-16.767476-43.83863-16.767476-60.47811 0-16.767476 16.703478-16.767476 43.83863 0 60.47811L451.441892 512.016l-438.834286 438.898284c-16.767476 16.703478-16.767476 43.83863 0 60.47811C20.863348 1019.84013 31.871004 1024 42.814662 1024s21.887316-4.15987 30.271054-12.543608L511.984 572.558108l438.898284 438.834286C959.266023 1019.84013 970.209681 1024 981.153339 1024s21.951314-4.15987 30.271054-12.543608c16.767476-16.703478 16.767476-43.83863 0-60.47811L572.462111 512.016z" p-id="2996"></path></svg>
  				</div>
  			</mu-list-item>
  		</mu-list>
  		<mu-list v-else>
...
<script>
  ...
  export default {
    ...
    computed: {
      songlist(){
  			return this.$store.state.musicBox.songlist
  		},
  		wyID(){
  			return this.$store.state.musicBox.musicData.wyID
  		},
      musicData(){
