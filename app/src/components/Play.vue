    ...
    <div class="main" v-show="!commentShow">
      <div class="header">
        ...
        <div class="control">
          ...
          <svg @click="$store.commit('nextSong')" t="1494522150855" class="icon" style="font-size:25px;width: 3em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;"
