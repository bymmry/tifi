...
sudo install_name_tool -change libmysqlclient.20.dylib \
/usr/local/mysql/lib/libmysqlclient.20.dylib \
/usr/local/lib/python2.7/site-packages/MySQL_python-1.2.4b4-py2.7-macosx-10.12-x86_64.egg/_mysql.so
